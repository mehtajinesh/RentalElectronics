      ...
      <div className="container my-5">
        ...
        <form>
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <button class="btn btn-secondary me-md-2 px-5 py-2" type="button" onClick={DeleteItem}>Remove</button>
            <button class="btn btn-primary px-5 py-2" type="button" onClick={UpdateItem}>Update</button>
          </div>
